...
{
    public class UpdateProductImageCommandHandler : IRequestHandler<UpdateProductImageCommandRequest, bool>
    {
        ...
        public async Task<bool> Handle(UpdateProductImageCommandRequest request, CancellationToken cancellationToken)
        {
