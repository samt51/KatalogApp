...
{
    public class UpdateStoneClarityCommandHandler : IRequestHandler<UpdateStoneClarityCommandRequest, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public UpdateStoneClarityCommandHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<bool> Handle(UpdateStoneClarityCommandRequest request, CancellationToken cancellationToken)
        {
